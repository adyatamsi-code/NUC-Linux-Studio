...
class NUCApp:
        ...
        try:
            if CONFIG_FILE.exists():
                with CONFIG_FILE.open("r", encoding="utf-8") as f:
                    cfg = json.load(f)
                self._current_theme_name = cfg.get("theme", "dark")
        except Exception:
            pass
    ...
    def create_footer(self, parent):
        ...
        theme_icon = "☀" if self._current_theme_name == "dark" else "🌙"
    ...
    def _toggle_theme(self):
        """Switch between dark and light themes. Restarts UI to fully apply."""
        ...
        try:
            ...
            if face_tab and hasattr(face_tab, '_faces_tree'):
                ...
                face_tab._faces_tree.tag_configure("snapshot",
                    foreground="#555555" if self.theme["name"] == "light" else "#C0C0C0",
                    font=("Segoe UI", 11))
        except Exception:
            pass
